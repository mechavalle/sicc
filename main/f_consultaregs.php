...
<?
			...
			while($val=mysqli_fetch_array($res))
				...
				if($minlev!=0)
					{
					if($IDL>=2)
						$link="<a href='#' onclick=\"abre('registro','f_registro.php?permiso=$permiso&minlev=$minlev&maxlev=$maxlev&desc=$desc&tabla=$tabla&tablacom=$tablacom&campo=$campo&id=$id',550,250,'NO');\">";
					else
						$link="";
					}
