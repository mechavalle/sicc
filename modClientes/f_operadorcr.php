...
?>						
				...
				<thead>
					<tr>
						<td><font face="Arial" size="2"><b>Documento</b></font></td>
						<td><font face="Arial" size="2"><b>Fecha Documento</b></font></td>
						<td><font face="Arial" size="2"><b>Información Extra</b></font></td>
					</tr>
				</thead>
				<tbody>
					<?
					...
					while($val8=mysqli_fetch_array($res))
						...
						$vfecha=fixfecha($val8['fecha']);
						$vextra="";
						if($val8['servicio']!="")
							$vextra .="<b>Servicio:</b> ".$val8['servicio']."<br>";
						if($val8['honorarios']!="")
							$vextra .="<b>Honorarios:</b> ".$val8['honorarios']."<br>";
						if($val8['duracion']!="")
							$vextra .="<b>Duración:</b> ".$val8['duracion']."<br>";
						if($val8['servicio']!="")
							$vextra .="<b>Servicio:</b> ".$val8['servicio']."<br>";	
							
						if($val8['puesto']!="")
							$vextra .="<b>Puesto:</b> ".$val8['puesto']."<br>";	
						if($val8['departamento']!="")
							$vextra .="<b>Departamento:</b> ".$val8['departamento']."<br>";	
						if($val8['actividades']!="")
							$vextra .="<b>Actividades:</b> ".$val8['actividades']."<br>";		
						if($val8['sueldodiario']!="")
							$vextra .="<b>Sueldo Diario:</b> ".$val8['sueldodiario']."<br>";	
						if($val8['jornada']!="")
							$vextra .="<b>Jornada de Trabajo:</b> ".$val8['jornada']."<br>";
						if($val8['secretario']!="")
							$vextra .="<b>Secretario General:</b> ".$val8['secretario']."<br>";	
						...
						if($val8['idformato']!="" && $IDL2>=3)
							...
							$link2="";	
						echo "<tr>
						<td>$link<font face='Verdana' size='1' color='#000000'>$vdescripcion</font></a>$link2</td>
						<td>$link<font face='Verdana' size='1' color='#000000'>$vfecha</font></a></td>
						<td>$link<font face='Verdana' size='1' color='#000000'>$vextra</font></a></td>						
						</tr>";
