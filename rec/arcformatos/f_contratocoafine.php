...
if($val5=mysqli_fetch_array($res2))
	...
	//$hoy="en $lugar a $dia de ".mes($mes)." de $anio";
	}
...
if($val5=mysqli_fetch_array($res2))
	...
	$valorneto=fixmonto($val5['valorneto']);
	$valornetov=strtoupper(convertir($val5['valorneto']));*/
	$representantelegal=$val5['representantelegal'];
	$idconstructora=$val5['idconstructora'];
	$escescritura=$val5['escescritura'];
...
$txt="<p>Que su representante cuenta con los poderes suficientes para representar y obligar a la sociedad en este acto, tal y como consta en la Escritura Pública Número $escescritura de fecha $escfecha, pasada ante la fe del Licenciado $escnotario, Notario Público número $escnotarionum, <vb>(anexo 3)</vb>, los cuales bajo protesta de decir la verdad manifiesta que no le han sido revocados ni modificados de forma alguna.</p>";
...
$txt="<p>Que su domicilio para los efectos del presente contrato se encuentra ubicado en $domiciliocons, se anexa comprobante de domicilio. <vb>(anexo 4)</vb>.</p>";
...
$txt="<p><vb>CUARTA.- </vb>En caso de que el “EL DERECHOHABIENTE” decidiera sustituir a la “CONSTRUCTORA” de acuerdo a su libre voluntad de selección de que constructora elija para la ejecución de los trabajos, mediante convenio este recibirá por parte de la “CONSTRUCTORA” <vb>$razonsocial</vb>    el importe de $ _____________________M.N., mediante cheque nominativo proveniente del crédito otorgado por parte del INSTITUTO DEL FONDO NACIONAL DE LA VIVIENDA PARA LOS TRABAJADORES, para que de acuerdo a su libre voluntad  pueda contratar a la “CONSTRUCTORA”  única y exclusivamente para la supervisión de los trabajos que ejecute la constructora elegida por el derechohabiente, mediante el pago de un porcentaje establecido sobre el crédito recibido por el acreditado para que éste a su vez, continúe con el trámite contractual de un tercero (Constructora) para la ejecución de la obra consistente en los trabajos encomendados.</p>";
$pdf->WriteTag(0,$es,$txt,0,"J");
$pdf->Ln(2);

$txt="<p><vb>QUINTA.-</vb> <p3>Entrega del crédito.</p3><vb>-</vb> En el caso de que  “EL DERECHOHABIENTE”  decidiera sustituir  a la “CONSTRUCTORA”  <vb>$razonsocial</vb> para la ejecución de  los trabajos de remodelación, acudirá a las oficinas de  esta  para la entrega del crédito otorgado, fondos que provienen del INSTITUTO DEL FONDO NACIONAL DE LA VIVIENDA PARA LOS TRABAJADORES, mediante  cheque nominativo que será otorgado por el encargado de cuentas por pagar  el día que acuerden ambas partes y firmará una copia que será archivado en el expediente para control, y queda a su libre voluntad de contratar a la  “CONSTRUCTORA” <vb>$razonsocial</vb> para la supervisión de la obra mediante el pago por el servicio prestado.</p>";
$pdf->WriteTag(0,$es,$txt,0,"J");
$pdf->Ln(2);

$txt="<p><vb>SEXTA.</vb> <p3>Impuestos.</p3><vb>-</vb> En el  acto  de que la “CONSTRUCTORA” <vb>$razonsocial</vb> entregue al derechohabiente el importe del préstamo otorgado, derivado de la sustitución del ejecutor de obra y de acuerdo a su libre voluntad de elegir a un tercero para la ejecución de los trabajos de remodelación no se genera ningún tipo de impuesto por considerarse un préstamo para remodelación, ampliación o construcción de casa habitación fondos que provienen  por parte del Instituto Nacional para la Vivienda de los Trabajadores  para la incorporación al programa de apoyo de línea cuatro conforme a la Legislación Fiscal vigente, obligándose el derechohabiente a pagar el crédito otorgado al Instituto.</p>";
$pdf->WriteTag(0,$es,$txt,0,"J");
$pdf->Ln(2);
...
$pdf->Cell(85,$es,"$razonsocial",0,1,"C");
$pdf->Ln(20);
...
$pdf->Cell(255,$es,"$representantelegal",0,1,"C");
$pdf->Ln(5);
