...
$txt="<p>Que su representante cuenta con los poderes suficientes para representar y obligar a la sociedad en este acto, tal y como consta en la Escritura Publica Número 69502 de fecha 5 de marzo de 2013, pasada ante la fe del Licenciado Luis De Angoitia Becerra, Notario Público número 230 del Distrito Federal, <vb>(anexo 3)</vb>, los cuales bajo protesta de decir verdad manifiesta que no le han sido revocados ni modificados de forma alguna.</p>";
...
$txt="<p>Que su domicilio para los efectos del presente contrato se encuentra ubicado en: <placee>ARGENTINOS 61, MARIA G DE GARCIA RUIZ, ALVARO OBREGON, CIUDAD DE MEXICO, C.P. 01160.</placee><br>                        </p>";
$pdf->Cell(10,$es,"B.",0,0,"C");
$pdf->WriteTag(0,$es,$txt,0,"J");
$pdf->Ln(0);
